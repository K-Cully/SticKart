...
namespace SticKart.Display
{
    ...
    class RenderableText
    {
        ...
        /// <summary>
        /// The unscaled size of the text. 
        /// </summary>
        private Vector2 size;

        /// <summary>
        /// Initalizes a new instance of the <see cref="RenderableText"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the unscaled width of the text.
        /// </summary>
        public float Width
        {
            get
        ...
        /// <summary>
        /// Gets the unscaled height of the text.
        /// </summary>
        public float Height
        {
            get
        ...
        /// <summary>
        /// Initalizes the renderable text and loads the associated font.
        /// </summary>
        ...
        /// <summary>
        /// Initalizes the text and loads the associated font.
        /// </summary>
        /// <param name="spriteBatch">The sprite batch to use when drawing.</param>
        /// <param name="contentManager">The content manager to load the content with.</param>
        /// <param name="pathToFont">The relative path to the font asset.</param>
        ...
        /// </summary>
        /// <param name="renderableText">The renderable text to draw.</param>
